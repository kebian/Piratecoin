...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Parameters
        //
        // If Qt is used, parameters/piratecoin.conf are parsed in qt/bitcoin.cpp's main()
        ...
        {
            // First part of help message is specific to piratecoind / RPC client
...
int main(int argc, char* argv[])
{
    ...
    // Connect piratecoind signal handlers
    noui_connect();
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 11656 or testnet: 21656)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 11655)") + "\n" +
