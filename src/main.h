...
static const int64 MAX_MONEY = 25000000 * COIN; // Piratecoin: maximum of 25M coins (given some randomness)
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; // Piratecoin: 1440 blocks found a day. Priority cutoff is 1 piratecoin day / 250 bytes.
    }
